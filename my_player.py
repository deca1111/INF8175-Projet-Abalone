...
class MyPlayer(PlayerAbalone):
    ...
    def compute_action(self, current_state: GameState, **kwargs) -> Action:
        ...
        #
        # score = heuristique.positionHeuristique(current_state)
        #
        ...
        #
        # score = heuristique.positionHeuristique(nextState)
        #
        # print("Score estimé de l'action : ", score)
        #
        # while (1):
        ...
        evaluation, action, metrics = algoRecherche.alphabeta_search_depthV2(current_state, heuristique.positionHeuristique, cutoff_depth=2)
